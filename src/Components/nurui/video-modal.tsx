      ...
      <AnimatePresence>
        {isVideoOpen && (
          ...
          >
            ...
            >
              <motion.button className="absolute -top-16 right-0 !border-0 rounded bg-white p-2 text-xl text-[var(--white-color)]  backdrop-blur-md">
                <XIcon className="size-5" />
              </motion.button>
              <div className="relative isolate z-[1] size-full overflow-hidden rounded">
                <iframe
                  src={videoSrc}
